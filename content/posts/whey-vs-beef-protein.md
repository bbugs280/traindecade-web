...
**And here's the part no vendor page will print about that study.** The trial behind it was **funded by Essentia Metabolic Proteins** — the ingredient manufacturer whose **BeefISO™** product it tested — and the authors declare it in the paper's own funding statement. This doesn't make the result wrong. A null result *favours* the funder's rival, not their product, and a company paying for a study that finds no difference is not the usual shape of industry bias. But you deserve to know the funding line before you weigh the number, because it's exactly the detail the sites selling you a tub leave out. **Note the venue change, too:** the "no difference" result was first presented as a **conference abstract in 2015** (JISSN 12(Suppl 1):P11), then published as a **full paper in 2018** (*J Strength Cond Res* 32(8):2233–2242) — and the 2018 trial tested **whey concentrate**, where beef, chicken and whey all came out even. The abstract you'll find cited by vendors is the 2015 version, which carries no funding statement at all. Check both: [PMID 28399016](https://pubmed.ncbi.nlm.nih.gov/28399016/) for the full paper, [PMC4595383](https://pmc.ncbi.nlm.nih.gov/articles/PMC4595383/) for the abstract.
...
- **Study funding disclosure** — Sharp et al., *J Strength Cond Res* 2018;32(8):2233–2242 (**PMID 28399016**) — the full paper declares **Essentia Metabolic Proteins provided funding, all of which went to The University of Tampa**, and the BeefISO™ ingredient tested is Essentia's own. The trial compared beef protein, hydrolyzed chicken protein and **whey concentrate** against a maltodextrin control and found no between-group differences. **Venue note:** the 2015 conference abstract (**PMC4595383**, JISSN 12(Suppl 1):P11) is the version most vendor pages cite and it carries **no funding statement** — the disclosure is in the 2018 full text.
